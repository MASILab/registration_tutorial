...
def run_preprocess_method(method_str, nii_file_path, mask_file_path, roi_region_path, output_file_path, fsl_root):
    if method_str == 'lung_seg_roi_clip_full':
        run_roi_clip(nii_file_path, mask_file_path, roi_region_path, output_file_path, fsl_root)
...
def run_roi_clip(ori_path, mask_path, roi_region_path, roi_clip_path, fsl_root=''):
